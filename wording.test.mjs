...
const SOURCES = ["./app.js", "./quality-extension.js", "./excel-export.js", "./conclusion.js", "./trend.js", "./trend-excel.js", "./column-filter.js", "./period-date.js", "./main-filters.js", "./main-toolbar.js", "./los-rule-scope.js"];
/** 位置／數量代稱。 */
...
function files() {
  ...
  for (const entry of SOURCES) {
    /* URL.pathname 在 Windows 會留下開頭斜線，交給 fs 後變成 D:\\D:\\...。 */
